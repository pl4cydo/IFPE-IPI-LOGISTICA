    ...
    <div id="dialogueArea">
      <div id="dialogueBox">
        <p id="p1" style="display:block;">
          O caminhão com a encomenda passou pela verificação de entrada e está
        ...
        <p id="p3" style="display:none;">
          ...
          atual clique em <span style="color:green">Aprovar</span> caso
          contrario clique em <span style="color:dodgerblue;">Trocar</span>.
        </p>
        ...
        <p id="p7" style="display:none;">
          Nota conferida com <span style="color: green;">sucesso</span>,
