...
<div id="recScreen">
  ...
  <div id="dialogueArea">
    <div id="dialogueBox">
      <p id="p1" style="display:block;">
        O caminhão com a carga passou pela verificação de entrada e está prestes
        a chegar na doca.
      </p>
      <p id="p2" style="display: none;">
        Clique na carga para verificar se ela está de acordo com a nota fiscal
        da encomenda.
      </p>
      <p id="p3" style="display:none;">
        Selecione umas das notas na direita, caso ela corresponda com a nota
        atual clique em <span style="color:green">Aprovar</span> caso contrario
        clique em <span style="color:dodgerblue;">Trocar</span>.
      </p>
      <p id="p4" style="display:none;">
        Você precisa selecionar uma nota antes de aprovar.
      </p>
      <p id="p5" style="display:none;">
        Esta nota não corresponde com a atual selecione outra nota clicando em <span
          style="color:dodgerblue;">Trocar</span
        >.
      </p>
      ...
      <p id="p7" style="display:none;">
        Nota conferida com <span style="color: green;">sucesso</span>, Continue
        verificando as notas.
      </p>
      <p id="p8" style="display:none;">
        Todas as notas foram conferidas com sucesso
      </p>
    </div>
    ...
    <div id="btnArea">
      <div
        id="changeBtn"
        style="color:white;background:dodgerblue; display:none;"
        on:click={() => {
          changeNf();
        }}
      >
      ...
      <div
        ...
        id="approveBtn"
        style="color:white;background:green; display:none;"
      >
        Aprovar
      </div>
      <!--Chama a Funcao Que Verifica Se a Nota Verificada Está Correta.-->
      <div
        id="skipBtn"
        on:click={() => {
      ...
      <!-- Chama a Funcao Que Altera a Imagem De fundo Do Jogo Para a Imagem Com a Doca Aberta.-->
    </div>
  </div>
  <div
    id="carga"
    ...
    on:click={() => {
      toggleElement("recTask"),
        changeDialogues("p2", "p3"),
        toggleElement("approveBtn"),
        toggleElement("changeBtn");
    }}
  />
  <!--Altera a Visibilidade do recTask, Troca o Dialogo do 2 Para o 3, Altera a Visibilidade Dos Botões de Interação.-->
  ...
  <div id="endScreen" style="display:none;">
    ...
    <p>
      No processo de armazenagem logistica, o ponto de recebimento é de grande
      importância. Esse ponto lida com o recebimento de produtos e a verificação
      dos mesmos. Esse processo é dividido em três partes:
    </p>
    <h4>Conferência da mercadoria</h4>
    <p>
      Assim que as mercadorias chegam no local de estocagem elas passam pelo
      processo de Conferência, no qual são avaliados detalhes como:estado do
      material, número de série, fabricação, validade, e lote.
    </p>
    <h4>Inspeção</h4>
    <p>
      Após a análise mais técnica feita da Conferência, você parte para a
      Inspeção no qual se verificam possíveis avarias ou não conformidades nos
      produtos
    </p>
    <h4>Identificação das mercadorias</h4>
    <p>
      A identificação é a sub etapa em que a mercadoria ganha um código de
      barras que será utilizado como principal referência em outras ações
      subsequentes, como contagem ou movimentação dentro do estoque.
    </p>
    <a
      href="https://www.twtransportes.com.br/logistica-de-armazenagem-por-que-e-importante/#:~:text=A%20log%C3%ADstica%20de%20armazenagem%20funciona,ter%20mais%20economia%20e%20resultado."
