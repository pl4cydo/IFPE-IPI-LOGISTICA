...
<div id="epiContainer">
    <div id="epiScreen">
        ...
        <div id="EndScreen" style="display: none;">
            ...
            <p>Os Equipamentos de Proteção Individual são regulamentados pela Norma Regulamentadora de número 6, que os define da seguinte forma: considera-se Equipamento de Proteção Individual – EPI, todo dispositivo ou produto, de uso individual utilizado pelo trabalhador, destinado à proteção de riscos suscetíveis de ameaçar a segurança e a saúde no trabalho.</p>
            <p>Além disso, para que seja considerado desta forma, é fundamental que o equipamento possua o que chamamos de Certificado de Aprovação (CA). Este certificado serve para assegurar que o produto tenha sido fabricado de maneira correta, de acordo com as regras de segurança para o trabalhador.</p>
            <p>Possuindo o Certificado de Aprovação e as características do primeiro parágrafo deste trecho do artigo, o equipamento certamente será considerado EPI. Assim, seu uso torna-se obrigatório e passível de multa em caso de descumprimento. </p>
            <p>Os EPIs possuem como principal objetivo proteger a saúde e a segurança física do trabalhador em situações onde as demais Medidas de Controle de Risco não forem suficientes. Ou seja, os equipamentos de proteção individual são a última das medidas preventivas contra Acidentes de Trabalho. </p>
            <a href="https://prometalepis.com.br/blog/a-importancia-do-uso-do-epi/#:~:text=Os%20EPIs%20possuem%20como%20principal,preventivas%20contra%20Acidentes%20de%20Trabalho." target="_blank">Para mais informações</a>
