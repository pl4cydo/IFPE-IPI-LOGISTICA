    ...
    let caixa = setInterval(() => {
      ...
      let text = [
        [
          ...
          "Opa! vejo que equipou o EPI já é um passo a mais da nossa check-list ",
          "não só isso a check-list envolve revisar a empilhadeira e se tiver tudo certo esta liberada para operar",
          "Vou levar a empilhadeira a um local adequado para podermos observar de perto pontos essenciais",
          "Vamos lá.",
        ],
        [
          /*motor*/ "",
          "abaixo do assento da empilhadeira existe o motor, bateria, filtro e outros. Mas vamos ficar em revisar regiões que contenham oleo para a lubrificação",
        ...
        [
          /*pneu*/ "",
          "sem muito segredo no pneu né?",
          "uma rapida olhada averiguando se esta murcho ou com avaria",
          "mas para evitar essas situações toda semana o pneu da empilhadeira deve ser calibrado",
          "dependendo do modelo da empilhadeira tem sua tabela de calibragem",
          "deve se atentar a isso",
          "o pneu esta descalibrado e na tabela desse pneu é 145 psi",
          "...",
        ...
        [
          /*arrefecimento*/ "",
          "o radiador é uma peça que serve de resfriamento do motor",
          "a tampa do radiador não pode ser aberta logo depois do uso da empilhadeira se retirado quente pode causar queimaduras",
          "espere ela esfriar para ai sim poder retirar a tampa",
          "ai sim podemos observar se o liquido do radiador esta normal",
          ...
          "bem tranquilo vamos ao proximo ",
        ],
        [
          /*giroflex*/ "",
          "essa luz luminosa é o giroflex",
        ...
        [
          ...
          " e em uma delas mostrarei como trocar caso seja necessario",
          "depois de todos os itens verificados finalize clicando no botão verde",
        ],
        [
          "",
